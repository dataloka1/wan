...
# ============================================================================
# MODEL REGISTRY - FIXED WORKING URLS
# ============================================================================
MODEL_REGISTRY = {
    # Wan 2.2 Models (14B parameters) - UPDATED LINKS
    "diffusion_models": {
        # T2V Model - dari Wan-AI repo
        "Wan2_2-T2V-14B_fp8_e4m3fn_scaled.safetensors": "https://huggingface.co/Wan-AI/Wan2.2-T2V-A14B/resolve/main/diffusion_pytorch_model.safetensors",
        # I2V Model - dari Wan-AI repo
        "Wan2_2-I2V-14B_fp8_e4m3fn_scaled.safetensors": "https://huggingface.co/Wan-AI/Wan2.2-I2V-A14B/resolve/main/diffusion_pytorch_model.safetensors",
    },
    "vae": {
        # VAE dari Comfy repackaged
    ...
    # Lora - EXPANDED COLLECTION
    "loras": {
        # === GAYA ARTISTIK & VISUAL ===
        "detail_tweaker_xl.safetensors": "https://civitai.com/api/download/models/135867?type=Model&format=SafeTensor",
        "film_grain.safetensors": "https://civitai.com/api/download/models/138564?type=Model&format=SafeTensor",
        "studio_ghibli.safetensors": "https://civitai.com/api/download/models/10617?type=Model&format=SafeTensor",
        "anime_lineart.safetensors": "https://civitai.com/api/download/models/94133?type=Model&format=SafeTensor",
        "cyberpunk_style.safetensors": "https://civitai.com/api/download/models/13988?type=Model&format=SafeTensor",
        "pixel_art_xl.safetensors": "https://civitai.com/api/download/models/135931?type=Model&format=SafeTensor",
        "3d_rendering.safetensors": "https://civitai.com/api/download/models/92832?type=Model&format=SafeTensor",
        "vintage_storybook.safetensors": "https://civitai.com/api/download/models/144798?type=Model&format=SafeTensor",
        "watercolor_style.safetensors": "https://civitai.com/api/download/models/92156?type=Model&format=SafeTensor",
        "ink_style.safetensors": "https://civitai.com/api/download/models/67891?type=Model&format=SafeTensor",
        
        # === KONSEP & OBJEK ===
        "rainy_day.safetensors": "https://civitai.com/api/download/models/97521?type=Model&format=SafeTensor",
        "smoke_fog.safetensors": "https://civitai.com/api/download/models/101582?type=Model&format=SafeTensor",
        "fire_flames.safetensors": "https://civitai.com/api/download/models/135789?type=Model&format=SafeTensor",
        "mechanical_parts.safetensors": "https://civitai.com/api/download/models/30733?type=Model&format=SafeTensor",
        "hologram_effect.safetensors": "https://civitai.com/api/download/models/125789?type=Model&format=SafeTensor",
        "neon_lights.safetensors": "https://civitai.com/api/download/models/15876?type=Model&format=SafeTensor",
        "explosion.safetensors": "https://civitai.com/api/download/models/139456?type=Model&format=SafeTensor",
        "steampunk_fashion.safetensors": "https://civitai.com/api/download/models/14321?type=Model&format=SafeTensor",
        "fantasy_architecture.safetensors": "https://civitai.com/api/download/models/145632?type=Model&format=SafeTensor",
        "food_photography.safetensors": "https://civitai.com/api/download/models/99234?type=Model&format=SafeTensor",
        
        # === KARAKTER & PAKAIAN ===
        "knights_armor.safetensors": "https://civitai.com/api/download/models/137845?type=Model&format=SafeTensor",
        "witch_fashion.safetensors": "https://civitai.com/api/download/models/134876?type=Model&format=SafeTensor",
        "japanese_kimono.safetensors": "https://civitai.com/api/download/models/16789?type=Model&format=SafeTensor",
        "scifi_armor.safetensors": "https://civitai.com/api/download/models/96234?type=Model&format=SafeTensor",
        "hoodie.safetensors": "https://civitai.com/api/download/models/96587?type=Model&format=SafeTensor",
        "leather_jacket.safetensors": "https://civitai.com/api/download/models/110789?type=Model&format=SafeTensor",
        "gothic_lolita.safetensors": "https://civitai.com/api/download/models/24567?type=Model&format=SafeTensor",
        "elves.safetensors": "https://civitai.com/api/download/models/14123?type=Model&format=SafeTensor",
        "robots_cyborgs.safetensors": "https://civitai.com/api/download/models/134567?type=Model&format=SafeTensor",
        "vampire.safetensors": "https://civitai.com/api/download/models/140234?type=Model&format=SafeTensor",
        
        # === POSE & KOMPOSISI ===
        "dynamic_poses.safetensors": "https://civitai.com/api/download/models/10234?type=Model&format=SafeTensor",
        "sitting_pose.safetensors": "https://civitai.com/api/download/models/95456?type=Model&format=SafeTensor",
        "fighting_stance.safetensors": "https://civitai.com/api/download/models/22345?type=Model&format=SafeTensor",
        "looking_back.safetensors": "https://civitai.com/api/download/models/10456?type=Model&format=SafeTensor",
        "depth_of_field.safetensors": "https://civitai.com/api/download/models/94789?type=Model&format=SafeTensor",
        "perfect_hands.safetensors": "https://civitai.com/api/download/models/99123?type=Model&format=SafeTensor",
        "split_screen.safetensors": "https://civitai.com/api/download/models/107890?type=Model&format=SafeTensor",
        "widescreen.safetensors": "https://civitai.com/api/download/models/93234?type=Model&format=SafeTensor",
        "from_below.safetensors": "https://civitai.com/api/download/models/54567?type=Model&format=SafeTensor",
        "closeup.safetensors": "https://civitai.com/api/download/models/93456?type=Model&format=SafeTensor",
        
        # === DETAIL ENHANCEMENT ===
        "better_eyes.safetensors": "https://civitai.com/api/download/models/121789?type=Model&format=SafeTensor",
        "fabric_details.safetensors": "https://civitai.com/api/download/models/110456?type=Model&format=SafeTensor",
        "hair_details.safetensors": "https://civitai.com/api/download/models/93678?type=Model&format=SafeTensor",
        "skin_details.safetensors": "https://civitai.com/api/download/models/94567?type=Model&format=SafeTensor",
        "jewelry_gems.safetensors": "https://civitai.com/api/download/models/99567?type=Model&format=SafeTensor",
        
        # === ENVIRONMENT ===
        "fantasy_forest.safetensors": "https://civitai.com/api/download/models/126789?type=Model&format=SafeTensor",
        "futuristic_city.safetensors": "https://civitai.com/api/download/models/93123?type=Model&format=SafeTensor",
        "horror_environment.safetensors": "https://civitai.com/api/download/models/93890?type=Model&format=SafeTensor",
        
        # === UTILITAS ===
        "lowra.safetensors": "https://civitai.com/api/download/models/69527?type=Model&format=SafeTensor",
        "add_detail.safetensors": "https://civitai.com/api/download/models/62833?type=Model&format=SafeTensor",
        
        # === CAMERA MOTION (AnimateDiff) ===
...
def download_single_model(model_type: str, filename: str, url: str, target_dir: Path) -> dict:
    ...
    try:
        ...
        # Add auth untuk Huggingface (tidak untuk CivitAI)
        ...
        if file_size < 0.5:  # Less than 0.5MB is suspicious
            target_path.unlink()
            return {
                "status": "error",
                "filename": filename,
...
def download_models():
    ...
    if hf_token:
        ...
        print("\n⚠️  Continuing anyway, HF downloads will fail...\n")
    ...
    for model_type in PRIORITY_ORDER:
        ...
        # Non-critical: parallel download (faster)
            ...
            with ThreadPoolExecutor(max_workers=3) as executor:  # Reduced workers for CivitAI rate limits
                futures = {
...
"""
    ...
    def get_wan2_2_workflow(self, payload: dict) -> Dict:
        """Build Wan 2.2 workflow - UPDATED FOR NEW MODEL"""
...
def fastapi_app():
    ...
    web_app = FastAPI(
        ...
        description="Production-ready 30-second video generation with 60+ LoRAs",
        version="3.1.0"
    )
    ...
    async def list_loras():
        ...
        return {
            ...
            "categories": {
                "artistic_style": [
                    "detail_tweaker_xl", "film_grain", "studio_ghibli", "anime_lineart",
                    "cyberpunk_style", "pixel_art_xl", "3d_rendering", "vintage_storybook",
                    "watercolor_style", "ink_style"
                ],
                "concepts_objects": [
                    "rainy_day", "smoke_fog", "fire_flames", "mechanical_parts",
                    "hologram_effect", "neon_lights", "explosion", "steampunk_fashion",
                    "fantasy_architecture", "food_photography"
                ],
                "characters_clothing": [
                    "knights_armor", "witch_fashion", "japanese_kimono", "scifi_armor",
                    "hoodie", "leather_jacket", "gothic_lolita", "elves",
                    "robots_cyborgs", "vampire"
                ],
                "pose_composition": [
                    "dynamic_poses", "sitting_pose", "fighting_stance", "looking_back",
                    "depth_of_field", "perfect_hands", "split_screen", "widescreen",
                    "from_below", "closeup"
                ],
                "detail_enhancement": [
                    "better_eyes", "fabric_details", "hair_details", "skin_details",
                    "jewelry_gems"
                ],
                "environment": [
                    "fantasy_forest", "futuristic_city", "horror_environment"
                ],
                "camera_motion": [
                    "v2_lora_ZoomIn", "v2_lora_ZoomOut", "v2_lora_PanLeft", "v2_lora_PanRight"
                ],
                "utilities": [
                    "lowra", "add_detail"
                ]
...
def cli():
    ...
    print("  • 60+ Loras (~5 GB)")
    print("  • Total: ~43 GB, Time: 20-40 minutes")
    print("=" * 70)
